...
const menuItems: SideNavItem[] = [
  ...
  },
  {
    name: "past-decisions",
    label: "Decisions",
    icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m14.5 12.5-8 8a2.12 2.12 0 0 1-3-3l8-8"/><path d="m16 16 6-6"/><path d="m8 8 6-6"/><path d="m9 7 8 8"/><path d="m21 11-8-8"/></svg>`
  },
  {
    name: "about",
    label: "About",
  ...
  },
  {
    name: "leaderboard",
    label: "Leaderboard",
    icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M8 21V10"></path><path d="M16 21V4"></path><path d="M12 21v-6"></path><path d="M4 21h16"></path></svg>`
  },
  {
    name: "docs",
    label: "Docs",
